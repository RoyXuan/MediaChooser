...
import com.vest.album.AutoFitTextureView;
...
//            saver = new ImageSaver(, new File(mFilePath));
        }
...
//    private boolean mFlashed;
    ...
    public static CameraBasicFragment newInstance(String path) {
    ...
    public void onAttach(Context context) {
        ...
        try {
            callback = (onPhotoCallback) context;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        cameraBtn = (Button) view.findViewById(R.id.camera_picture);
        cameraBtn.setOnClickListener(this);
        sureBtn = (Button) view.findViewById(R.id.camera_sure_btn);
        sureBtn.setOnClickListener(this);
        cancelBtn = (Button) view.findViewById(R.id.camera_cancel_btn);
        cancelBtn.setOnClickListener(this);
        sureLayout = view.findViewById(R.id.camera_sure_layout);
//        view.findViewById(R.id.info).setOnClickListener(this);
        mTextureView = (AutoFitTextureView) view.findViewById(R.id.camera_texture);
        if (savedInstanceState == null) {
            mFilePath = getArguments().getString(PHOTO_PATH);
        } else {
            mFilePath = savedInstanceState.getString(PHOTO_PATH);
        }
//        ToggleButton flash = (ToggleButton) view.findViewById(R.id.camera_flash_toggle);
//        flash.setOnToggleChanged(new ToggleButton.OnToggleChanged() {
//            @Override
...
//        });
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putString(PHOTO_PATH, mFilePath);
    }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            callback.onPhotoError("连接相机失败！");
            e.printStackTrace();
        } catch (NullPointerException e) {
            // Currently an NPE is thrown when the Camera2API is used but not supported on the
            // device this code runs.
            callback.onPhotoError(getString(R.string.camera_error));
        }
    }
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface, mImageReader.getSurface()),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigureFailed(
                            ...
                            callback.onPhotoError("相机属性配置失败！");
                        }
                    }, null
            );
        } catch (CameraAccessException e) {
