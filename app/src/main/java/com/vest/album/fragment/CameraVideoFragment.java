...
public class CameraVideoFragment extends Fragment
    ...
    public static CameraVideoFragment newInstance(String path) {
    ...
    public interface onResultCallback {
        void onVideoSuccess(String path);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mButtonVideo = (Button) view.findViewById(R.id.camera_picture);
        mButtonVideo.setText("开始");
        mButtonVideo.setOnClickListener(this);
        Bundle arguments = getArguments();
//        if (arguments == null) {
//            mNextVideoAbsolutePath = ((CameraActivity) getActivity()).getVideoFilePath();
//        } else
            mNextVideoAbsolutePath = arguments.getString(VIDEO_PATH);
//        view.findViewById(R.id.camera_flash_layout).setVisibility(View.GONE);
    }
...
//        mButtonVideo.setText(R.string.record);
        ...
        Activity activity = getActivity();
        if (null != activity) {
            callback.onVideoSuccess(mNextVideoAbsolutePath);
        }
